...
const BookDetail = () => {
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-6">
        ...
        <p className="text-gray-600 mb-8 text-center max-w-md">
          The book you are looking for might have been moved or deleted.
        </p>
        <Link to="/books">
  ...
  // Get related books (same tag, excluding current)
  const relatedBooks = allBooks
    .filter(
      (b) =>
        b.id !== book.id &&
        b.tags.some((t) => book.tags.some((bt) => bt.id === t.id))
    )
    .slice(0, 3);
        ...
        <section className="relative bg-linear-to-br from-primary-900 to-secondary-900 text-white py-16">
          ...
          <div className="relative container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div
                className="text-lg md:text-xl text-gray-300 font-lato mb-8 max-w-3xl mx-auto"
            ...
            <div className="max-w-4xl mx-auto">
              <div className="flex flex-col justify-items-center md:justify-items-start md:flex-row items-center gap-6 p-6 bg-gray-50 rounded-2xl">
                <div className="w-16 h-16 bg-primary-100 rounded-full flex items-center justify-center shrink-0 overflow-hidden">
                  {book.authorProfilePic ? (
                    <img
                      src={book.authorProfilePic}
                      alt={book.authorName}
                ...
                <div className="flex-1 text-center md:text-left">
                  <h3 className="text-xl font-poppins font-semibold text-gray-900 mb-2">
                    About {book.authorName}
                  </h3>
                  <p className="text-gray-600 font-lato">
                    {book.authorName} is a dedicated spiritual practitioner and
                      ...
                      <div className="group bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                        ...
                        <div className="p-6">
                          ...
                          <div className="flex items-center gap-2 text-xs text-gray-500">
                            ...
                            <span>{relatedBook.authorName}</span>
                            <span>•</span>
                            <Calendar className="w-3 h-3" />
                            <span>
                              {new Date(
                                relatedBook.createdAt
                              ).toLocaleDateString()}
                            </span>
                          </div>
                        </div>
