        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl leading-tight font-poppins">
                ...
                <span className="relative inline-block">
                  ...
                  <div className="absolute -bottom-2 left-0 right-0 h-1 bg-linear-to-r from-primary-200 to-secondary-200 rounded-full"></div>
                </span>{' '}
                meets the unseen
              </h2>
            </div>
            ...
            <p className="text-lg md:text-xl text-gray-600 font-lato leading-relaxed">
              <strong className="text-primary-700">The Bridge</strong> is a
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4 p-4 rounded-2xl bg-white shadow-sm border border-primary-100 hover:shadow-md transition-shadow">
                <div className="shrink-0 w-12 h-12 bg-linear-to-r from-primary-500 to-secondary-500 rounded-xl flex items-center justify-center">
          ...
          <div className="mt-8 lg:mt-0 flex justify-center items-center">
            <div className="relative">
              ...
              <div className="absolute -top-8 -left-8 w-32 h-32 bg-linear-to-r from-primary-200 to-secondary-200 rounded-3xl -z-10 transform rotate-12 opacity-60"></div>
              <div className="absolute -bottom-8 -right-8 w-24 h-24 bg-linear-to-r from-secondary-200 to-primary-200 rounded-3xl -z-10 transform -rotate-12 opacity-60"></div>

              <div className="relative rounded-full h-80 w-80 border-2 border-primary-100 lg:h-105 lg:w-105 bg-white shadow-2xl">
